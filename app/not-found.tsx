...
export default function NotFound() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-zinc-950 font-sans selection:bg-indigo-500/30">
      {/* Texture Layer: Grid */}
      ...
      <div className="absolute -top-24 -left-24 h-96 w-96 rounded-full bg-indigo-600/10 blur-[120px]" />
      ...
      <div className="relative z-10 flex flex-col items-center space-y-12 px-6 text-center">
        <div className="space-y-4">
          ...
          <div className="h-[1px] w-12 mx-auto bg-indigo-500/50" />
        </div>
