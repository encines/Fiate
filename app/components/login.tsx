  ...
  return (
    <div className="relative flex min-h-screen overflow-x-hidden bg-zinc-950 font-sans selection:bg-orange-500/30">
      ...
      <div className="relative hidden lg:flex lg:w-1/2 flex-col justify-between p-12 overflow-hidden border-r border-white/5">
        ...
        <div className="absolute -top-24 -left-24 h-96 w-96 rounded-full bg-orange-600/20 blur-[120px]" />
        ...
        <div className="relative z-10 space-y-6">
          <h2 className="text-6xl font-medium tracking-tighter text-white leading-tight">
            Bienvenido al <br /> <span className="text-orange-500">futuro de tu garaje.</span>
          </h2>
      ...
      <div className="relative flex w-full flex-col items-center justify-center p-8 lg:w-1/2">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-orange-500/5 blur-[120px]" />
        ...
        <div className="relative z-10 w-full max-w-sm space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="group space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" data-id="forgot-password-link" className="text-[10px] font-bold uppercase tracking-widest text-orange-500 hover:text-orange-400">
                    ¿Olvidaste la clave?
                  </Link>
                </div>
                <input
          ...
          <p className="text-center text-xs font-bold uppercase tracking-[0.2em] text-zinc-600">
            ¿Nuevo en el club?{" "}
            <Link href="/register" className="text-white hover:text-orange-400 transition-colors">
              Crea tu cuenta
            </Link>
          </p>
        </div>
