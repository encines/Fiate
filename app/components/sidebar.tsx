...
export default function SiderBar({ cars = [], activeCarId = null, catalogCars = [], onClose }: SidebarProps) {
  ...
  return (
    <aside className="w-64 h-full border-r border-zinc-800 bg-zinc-950 text-white flex-shrink-0 flex flex-col">
      <div className="sticky top-0 p-6 flex flex-col h-screen">
        <div className="mb-8 flex items-center gap-3 px-2">
          ...
          <span className="text-xl font-bold tracking-tight">AutoLedger</span>
        </div>
        ...
        <div className="mt-auto pb-6 space-y-4">
          ...
          <button className="flex w-full items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium text-zinc-400 hover:bg-zinc-900 hover:text-white transition-all">
