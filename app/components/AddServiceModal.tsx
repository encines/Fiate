  ...
  return (
    <>
      <button
        ...
        className="flex w-full items-center gap-3 rounded-xl border border-transparent px-4 py-2.5 text-sm font-medium text-zinc-200 transition-colors hover:border-zinc-700 hover:bg-zinc-800/70"
      >
      ...
      {isOpen && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-5xl max-h-[95vh] rounded-[32px] border border-zinc-700/80 bg-zinc-900 shadow-2xl overflow-hidden flex flex-col">
            {/* Header - Fixed */}
            <div className="p-6 md:p-8 border-b border-zinc-800 flex-shrink-0">
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-white tracking-tight">Nuevo Registro de Servicio</h2>
                  <p className="mt-1 text-sm text-zinc-400">Completa los detalles para mantener el historial de tu flota impecable.</p>
                </div>
                <button 
                  onClick={() => setIsOpen(false)}
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-zinc-700 text-zinc-400 hover:bg-zinc-800 hover:text-white transition-colors"
                >
                  ✕
                </button>
              </div>
              ...
              <form id="service-form" action={formAction}>
                ...
                <div className="grid gap-6 lg:grid-cols-[1fr_320px]">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="rounded-3xl border border-zinc-800 bg-zinc-950/40 p-6 space-y-6">
                      <div className="flex items-center gap-2 text-indigo-400 font-medium uppercase text-xs tracking-widest">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between rounded-2xl border border-zinc-800 bg-zinc-900/50 p-4">
                          ...
                          <button type="button" className="text-xs font-bold text-indigo-400 hover:text-indigo-300">CAMBIAR</button>
                        </div>
                      </div>
                      ...
                      <div className="grid gap-4 sm:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-white focus:border-indigo-500 focus:outline-none transition-all"
                          />
                        </div>
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <input 
                              ...
                              className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-white focus:border-indigo-500 focus:outline-none transition-all pr-12"
                            />
                      ...
                      <div className="space-y-2">
                        ...
                        <select className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-white focus:border-indigo-500 focus:outline-none transition-all appearance-none">
                    ...
                    <div className="rounded-3xl border border-zinc-800 bg-zinc-950/40 p-6 space-y-4">
                      <div className="flex items-center gap-2 text-indigo-400 font-medium uppercase text-xs tracking-widest">
                      ...
                      <div className="grid gap-2 sm:grid-cols-2 md:grid-cols-3">
                        {[...DEFAULT_TASKS, ...customTasks].map((task) => (
                          <label key={task} className={`flex items-center gap-2 rounded-xl border px-3 py-2.5 cursor-pointer transition-all ${selectedTasks.includes(task) ? "border-indigo-500/50 bg-indigo-500/10 text-white" : "border-zinc-800 bg-zinc-900/50 text-zinc-500 hover:border-zinc-700"}`}>
                            <input 
                              type="checkbox" 
                              className="hidden" 
                            ...
                            />
                            <div className={`flex h-4 w-4 items-center justify-center rounded border transition-colors ${selectedTasks.includes(task) ? "bg-indigo-500 border-indigo-500" : "border-zinc-700"}`}>
                      ...
                      <div className="flex gap-2 pt-2">
                        <input 
                          ...
                          className="flex-1 rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-2 text-xs text-white focus:border-indigo-500 focus:outline-none transition-all"
                        />
                        <button 
                          type="button" 
                          onClick={addCustomTask}
                          className="rounded-xl bg-indigo-500/20 px-4 py-2 text-xs font-bold text-indigo-400 hover:bg-indigo-500 hover:text-white transition-colors"
                        >
                          AGREGAR
                        </button>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            step="0.01"
                            placeholder="0.00"
                            className="w-full rounded-xl border border-zinc-800 bg-zinc-900 pl-8 pr-4 py-3 text-right text-2xl font-bold text-white focus:border-indigo-500 focus:outline-none transition-all"
                          />
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="rounded-3xl border border-zinc-800 bg-zinc-950/40 p-6 space-y-4">
                    ...
                    <label className="border-2 border-dashed border-zinc-800 rounded-2xl p-6 flex flex-col items-center justify-center gap-2 bg-zinc-900/30 hover:bg-zinc-900/50 transition-colors cursor-pointer group">
                      <input 
                        type="file" 
                        name="image" 
                        className="hidden" 
                  ...
                  {/* Notes Card */}
                  <div className="rounded-3xl border border-zinc-800 bg-zinc-950/40 p-6 space-y-3">
                    <div className="flex items-center gap-2 text-indigo-400 font-medium uppercase text-xs tracking-widest">
                    ...
                    <textarea 
                      ...
                      className="w-full h-24 rounded-xl border border-zinc-800 bg-zinc-900 p-3 text-xs text-white focus:border-indigo-500 focus:outline-none transition-all resize-none"
                    ></textarea>
                  </div>
                  </div>
                </div>
            ...
            {/* Footer - Fixed */}
            <div className="p-6 md:p-8 border-t border-zinc-800 bg-zinc-900/50 flex-shrink-0">
              <div className="flex flex-col sm:flex-row justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setIsOpen(false)}
                  className="order-2 sm:order-1 rounded-2xl px-8 py-3 text-sm font-bold text-zinc-500 hover:bg-zinc-800 hover:text-white transition-all"
                >
                  Cancelar
                </button>
                <button
