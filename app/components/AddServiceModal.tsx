...
export default function AddServiceModal({
  ...
  const addCustomTask = () => {
    if (
      ...
      !DEFAULT_TASKS.includes(customTaskInput.trim()) &&
      !customTasks.includes(customTaskInput.trim())
    ) {
  ...
  return (
    <>
      ...
      {isOpen &&
        createPortal(
          <div
            className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/70 backdrop-blur-sm p-0 sm:p-4"
            role="dialog"
            aria-modal="true"
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                      Completa los detalles para mantener el historial de tu
                      auto impecable.
                    </p>
                  </div>
                  <button
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <p className="text-[10px] text-zinc-500 uppercase tracking-widest">
                                  {activeCar?.year} · PLACAS:{" "}
                                  {activeCar?.licensePlate || "N/A"}
                                </p>
                              </div>
                            </div>
                          </div>
