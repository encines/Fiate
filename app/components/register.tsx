  ...
  return (
    <div className="relative flex min-h-screen overflow-x-hidden bg-zinc-950 font-sans selection:bg-orange-500/30">
      ...
      <div className="relative hidden lg:flex lg:w-1/2 flex-col justify-between p-12 overflow-hidden border-r border-white/5">
        <div
          className="absolute inset-0 z-0 opacity-20 [mask-image:radial-gradient(ellipse_at_center,black,transparent)]"
          style={{
        ...
        <div className="relative z-10 space-y-6">
          <h2 className="text-6xl font-medium tracking-tighter text-white leading-tight">
            Eleva el estándar <br />{" "}
            <span className="text-teal-400">de tu mantenimiento.</span>
          </h2>
          <p className="max-w-md text-lg text-zinc-500">
            Únete a la plataforma que está cambiando la forma en que los dueños
            de autos cuidan su inversión.
          </p>
        </div>
