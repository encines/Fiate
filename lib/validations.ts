...
export const ReminderSchema = z.object({
  ...
  date: z.coerce
    .date()
    .min(new Date(), "El recordatorio debe ser para una fecha futura."),
...
export const AddMaintenanceTaskSchema = z.object({
  ...
  name: z
    .string()
    .min(2, "El nombre de la tarea debe tener al menos 2 caracteres."),
  frequencyKm: z.coerce
    .number()
    .int()
    .min(100, "La frecuencia mínima es de 100 km."),
});
